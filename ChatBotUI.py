...
project = ["Computer Vision", "Natural Language Processing", "Data Science", "Certificate"]
load_dotenv()
...
if select_project == project[1]:
    ...
    with col4:
        pdf_viewer("assets/documents/Certificate of Completion Mastering AI Bootcamp - Kurnia Zulda Matondang.pdf")
...
if select_project == project[-1]:
    ...
    with col1:
        ...
        pdf_viewer("assets/documents/Certificate of Excellence Mastering AI Bootcamp - Kurnia Zulda Matondang.pdf")
